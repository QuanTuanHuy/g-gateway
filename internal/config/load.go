...
func Decode(r io.Reader) (BootstrapConfig, model.ResourceSet, error) {
	...
	case apiVersionV1Alpha5:
		...
		return bootstrap, resources, nil
	case apiVersionV1Alpha6:
		var wire documentV6
		if err := decodeStrict(data, &wire); err != nil {
			return BootstrapConfig{}, model.ResourceSet{}, err
		}
		bootstrap, resources, err := convertV6(wire)
		if err != nil {
			return BootstrapConfig{}, model.ResourceSet{}, err
		}
		if err := validateV6(wire.APIVersion, &bootstrap, &resources); err != nil {
			return BootstrapConfig{}, model.ResourceSet{}, err
		}
		return bootstrap, resources, nil
	case apiVersionV1Alpha7:
		...
		return bootstrap, resources, nil
	case apiVersionV1Alpha8:
		var wire documentV8
		if err := decodeStrict(data, &wire); err != nil {
			return BootstrapConfig{}, model.ResourceSet{}, err
		}
		bootstrap, resources, err := convertV8(wire)
		if err != nil {
			return BootstrapConfig{}, model.ResourceSet{}, err
		}
		if err := validateV8(wire.APIVersion, &bootstrap, &resources); err != nil {
			return BootstrapConfig{}, model.ResourceSet{}, err
		}
		return bootstrap, resources, nil
	default:
