...
func (h *runtimeHandler) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
...
func (h *runtimeHandler) handleProxyError(writer http.ResponseWriter, request *http.Request, err error) {
...
func (h *runtimeHandler) writeMatchedResponse(
...
func (h *runtimeHandler) writeShortCircuit(
	writer http.ResponseWriter,
	request *http.Request,
	state *requestctx.Context,
...
func (h *runtimeHandler) writeMatchedHTTPResponse(
	writer http.ResponseWriter,
	_ *http.Request,
	state *requestctx.Context,
	status int,
